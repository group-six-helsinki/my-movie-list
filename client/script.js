    ...
    .done((movies) => {
      ...
      <div class="card" style="width: 18rem;">
        <img class="card-img-top" src="https://image.tmdb.org/t/p/w500${
          movie.poster
        }" alt="movie poster" width=750 height=500 >
        <div class="card-body">
        ...
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item">Year: ${formatYear(
            movie.release_year
          )}</li>
        </ul>
        <div class="card-body">
          <a href="#" class="card-link" onclick="addToMyMovie('${
            movie.title
          }', '${movie.synopsis}', '${movie.poster}','${
          movie.rating
        }','${formatYear(movie.release_year)}',)">Add to My List</a>
        </div>
      </div>
    </div>
      `);
